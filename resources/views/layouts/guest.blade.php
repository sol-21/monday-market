...
<body class="animsition">
    ...
    <!-- Header -->
    <header class="{{ Route::current()->getName() === 'welcome' ? '' : 'header-v4' }}">
        ...
        <div class="modal-search-header flex-c-t trans-04 js-hide-modal-search">
            <div class="container-search-header">
                ...
                <form action="{{ route('search') }}" method="GET" role="search">
                    <div class="wrap-search-header flex-w p-l-15 search-container">

                        <input class="plh3" type="search" id="search" value=''
    ...
    <footer class="bg3 p-t-75 p-b-32" id="footer-contact">
        <div class="container">
            <div class="row">
